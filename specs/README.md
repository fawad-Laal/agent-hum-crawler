...
- `01-product-spec.md`: product goals, users, scope, requirements, and success metrics.
- `02-technical-spec.md`: system architecture, data model, workflows, and operational constraints.
...
- `docs/research/04-agent-prompts.md`
- `docs/research/05-config-template.md`
